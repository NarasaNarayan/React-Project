...
useEffect(() => {
  ...
  return (
    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="200" height="200" fill="currentColor" className="bi bi-cart-x-fill text-danger  " viewBox="0 0 16 16" style={{marginLeft:'40%',marginTop:'100px'}}>
...
<h2 className='' style={{marginLeft:'42%'}}>Cart is Emty</h2>
        </div>
         :
      <div>
        { } <div class="row ">
                ...
                <div class="col-12 col-md-12 col-lg-12">
                  <div class="row  mt-2 shadow-sm p-4">
                    ...
                    <div class="col-12 col-sm-3  col-md-3 col-lg-3 mx-auto my-auto">
                      <div class="row">
                        <div class="col ">
                          <p className=''><span className='fs-5'>Price-</span></p>
                        </div>
